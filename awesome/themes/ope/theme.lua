--[[
   ...
   Ope Awesome WM config 1.0
   Adapted from Multicolor Awesome WM config 2.0 github.com/copycat-killer
...
theme.confdir                       = os.getenv("HOME") .. "/.config/awesome/themes/ope"
...
theme.fg_focus                      = "#8ca1ed"
theme.fg_urgent                     = "#de5e1e"
