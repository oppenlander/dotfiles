...
#+BEGIN_SRC emacs-lisp
  (quelpa 'org-jira)
  (require 'org-jira)
  (unbind-key "C-c pg" org-jira-entry-mode-map)
  (unbind-key "C-c sc" org-jira-entry-mode-map)
  (unbind-key "C-c sg" org-jira-entry-mode-map)
  (unbind-key "C-c cu" org-jira-entry-mode-map)
  (unbind-key "C-c tj" org-jira-entry-mode-map)
  (bind-key "C-c ipg" 'org-jira-get-projects org-jira-entry-mode-map)
  (bind-key "C-c isc" 'org-jira-create-subtask org-jira-entry-mode-map)
  (bind-key "C-c isg" 'org-jira-get-subtasks org-jira-entry-mode-map)
  (bind-key "C-c isu" 'org-jira-update-subtask org-jira-entry-mode-map)
  (bind-key "C-c itj" 'org-jira-todo-to-jira org-jira-entry-mode-map)
  (org-jira-mode 1)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (require 'gitlab)
  (require 'helm-gitlab)
  (setq gitlab-host "https://git.zipscene.com"
        gitlab-username "aoppenlander"
        gitlab-password "aoppenlander")
  (bind-key "C-c C-h g" 'helm-gitlab-projects)
  (bind-key "C-c C-h C-g" 'helm-gitlab-issues)
#+END_SRC
